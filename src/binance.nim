...
proc postOrderFutures*(self: Binance; symbol: string; side: Side; tipe: OrderType; quantity, activationPrice: float; callbackRate: 0.1 .. 5.0): string =
  result = ""
  unrollEncodeQuery(result, {"symbol": symbol, "side": $side, "type": $tipe, "timeInForce": "GTC", "quantity": $quantity, "activationPrice": $activationPrice, "callbackRate": $callbackRate})
  self.signQueryString"https://fapi.binance.com/fapi/v1/order"
...
template getMaxLeverage*(ticker: string): int =
  ...
  of "ALGOUSDT", "ATOMUSDT", "BSVUSDT", "DOGEUSDT", "DOTUSDT", "EGLDUSDT", "FILUSDT", "HNTUSDT", "ICPUSDT", "KSMUSDT", "MATICUSDT", "NEOUSDT", "QTUMUSDT", "RUNEUSDT", "SOLUSDT", "SRMUSDT", "SUSHIUSDT", "UNIUSDT", "XLMUSDT", "XTZUSDT", "ZECUSDT": 50
  of "BTCDOMUSDT", "QNTUSDT": 20
  else: 25  # "YFIUSDT", "MKRUSDT", "XMRUSDT", "AAVEUSDT", etc
...
template getMinQuantity*(ticker: string): float =
  ...
  of "BNBUSDT", "DOTUSDT", "SOLUSDT", "LINKUSDT", "AVAXUSDT", "ATOMUSDT", "FILUSDT", "UNIUSDT", "ETCUSDT", "QNTUSDT", "AAVEUSDT": 0.1
  else: 0.001
